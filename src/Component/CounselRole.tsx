...
function CounselRole (props: any) {
  ...
  const dataFromApi = new DataManager({
    ...
    insertUrl: `${REACT_APP_BASE_URL}/counselrole`,
    updateUrl: `${REACT_APP_BASE_URL}/counselrole`,
    removeUrl: `${REACT_APP_BASE_URL}/counselrole`,
