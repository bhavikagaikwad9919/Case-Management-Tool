...
function WitnessFor(props: any) {
  ...
  const dataFromApi = new DataManager({
    url: `${REACT_APP_BASE_URL}/WitnessFor`,
    insertUrl: `${REACT_APP_BASE_URL}/WitnessFor`,
    updateUrl: `${REACT_APP_BASE_URL}/WitnessFor`,
    removeUrl: `${REACT_APP_BASE_URL}/WitnessFor`,
  ...
  //     axios
  //       .patch(
  //         `${REACT_APP_BASE_URL}/Posture?id=${args.data.id}`,
  //         {
  //           Title: args.data.title,
  //         }
  //       )
