...
function VehiclePurchaseType(props: any) {
  ...
  const dataFromApi = new DataManager({
    ...
    insertUrl: `${REACT_APP_BASE_URL}/VehiclePurchaseType`,
    updateUrl: `${REACT_APP_BASE_URL}/VehiclePurchaseType`,
    removeUrl: `${REACT_APP_BASE_URL}/VehiclePurchaseType`,
...
export default VehiclePurchaseType;
