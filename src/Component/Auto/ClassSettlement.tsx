...
import ClassSettlementDialogEdit from "./ClassSettlementDialogEdit";
...
export function ClassSettlement(this: any) {
  ...
  const formatDate: any = {format: 'M/d/y a' };
  ...
  const dataFromApi = new DataManager({
    ...
    insertUrl: `${REACT_APP_BASE_URL}/ClassSettlementType`,
    updateUrl: `${REACT_APP_BASE_URL}/ClassSettlementType`,
    removeUrl: `${REACT_APP_BASE_URL}/ClassSettlementType`,
  ...
  function actionComplete(args: any) {
    ...
    if (dialog && dialog.header) {
      dialog.header = args.requestType === 'add' ? "Add Class Settlement" : "Edit Class Settlement"
      dialog.width = '500px'
    }
  }

  const dialogTemplate = (props: any) => {
    return (<ClassSettlementDialogEdit {...props} />);
  }
...
<div className="bg-[#EDEDED] ">
        ...
        >
            ...
            />
            <ColumnDirective
              field='DateSettlement'
              headerText='Date Settlement'
              format={format}
