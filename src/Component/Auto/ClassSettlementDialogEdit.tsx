...
function ClassSettlementDialogEdit(props: any) {
                ...
                <div className="mt-1 ml-6">
                    <div className="container">
                        ...
                        <div className="grid lg:grid-cols-1 p-2">
                            ...
                            <h2 className="heading">Date Settlement</h2>
                            <DatePickerComponent
                                placeholder="Enter Court Description"
                                className="e-multi-line-input"
                                id="datetimepicker"
                                name="DateSettlement"
                                value={localState.DateSettlement}
                                data-msg-containerid="errroForDateFiled"
                                onChange={(e: any) => {
                                    handlelocalStateChange("DateSettlement", e.target.value);
                                }}
                            />
...
export default ClassSettlementDialogEdit
