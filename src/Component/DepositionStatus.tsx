...
function DepositionStatus(props: any) {
  ...
  const dataFromApi = new DataManager({
    ...
    insertUrl: `${REACT_APP_BASE_URL}/depositionstatus`,
    updateUrl: `${REACT_APP_BASE_URL}/depositionstatus`,
    removeUrl: `${REACT_APP_BASE_URL}/depositionstatus`,
  ...
  //   if (args.action === "add") {
  //     axios
  //       .post(`${REACT_APP_BASE_URL}/depositionstatus`,
  //         {
  ...
  //     axios
  //       .patch(`${REACT_APP_BASE_URL}/depositionstatus?id=${args.data.id}`,
  //         {
  //           Title: args.data.title,
  //         }
  //       )
...
<div className="bg-[#EDEDED] ">
    ...
    >
      ...
      <ColumnDirective
        ...
        ></ColumnDirective>
        {/* <ColumnDirective
          field="injuryDepositions"
          headerText="Injury Depositions"
          width="160"
          allowEditing={false}
        ></ColumnDirective>
        <ColumnDirective
          field="witnessDepositions"
          headerText="Witness Depositions"
          width="160"
          allowEditing={false}
        ></ColumnDirective> */}
        <ColumnDirective
...
export default DepositionStatus;
