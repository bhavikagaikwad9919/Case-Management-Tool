...
function DeadlineDateType(props: any) {
    ...
    const dataFromApi = new DataManager({
        ...
        insertUrl: `${REACT_APP_BASE_URL}/DeadlineDateType`,
        updateUrl: `${REACT_APP_BASE_URL}/DeadlineDateType`,
        removeUrl: `${REACT_APP_BASE_URL}/DeadlineDateType`,
...
export default DeadlineDateType
