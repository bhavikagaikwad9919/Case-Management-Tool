import {
  ...
  function CounselFor(props: any) {
    ...
    const dataFromApi = new DataManager({
      ...
      insertUrl: `${REACT_APP_BASE_URL}/counselfor`,
      updateUrl: `${REACT_APP_BASE_URL}/counselfor`,
      removeUrl: `${REACT_APP_BASE_URL}/counselfor`,
