...
function MatterType(props: any) {
  ...
  const dataFromApi = new DataManager({
    ...
    insertUrl: `${REACT_APP_BASE_URL}/mattertype`,
    updateUrl: `${REACT_APP_BASE_URL}/mattertype`,
    removeUrl: `${REACT_APP_BASE_URL}/mattertype`,
  ...
  //     axios
  //       .patch(
  //         `${REACT_APP_BASE_URL}/mattertype?id=${args.data.id}`,
