...
function ClientContactType(props: any) {
  ...
  const dataFromApi = new DataManager({
    url: `${REACT_APP_BASE_URL}/ClientContactType`,
    insertUrl: `${REACT_APP_BASE_URL}/ClientContactType`,
    updateUrl: `${REACT_APP_BASE_URL}/ClientContactType`,
    removeUrl: `${REACT_APP_BASE_URL}/ClientContactType`,
...
export default ClientContactType;
