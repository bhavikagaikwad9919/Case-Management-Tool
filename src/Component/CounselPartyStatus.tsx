import {
  ...
  function CounselPartyStatus (props: any) {
    ...
    const dataFromApi = new DataManager({
      ...
      insertUrl: `${REACT_APP_BASE_URL}/counselpartystatus`,
      updateUrl: `${REACT_APP_BASE_URL}/counselpartystatus`,
      removeUrl: `${REACT_APP_BASE_URL}/counselpartystatus`,
  ...
  export default CounselPartyStatus ;
