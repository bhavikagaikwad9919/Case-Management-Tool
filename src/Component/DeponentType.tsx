...
function DeponentType(props: any) {
  ...
  const dataFromApi = new DataManager({
    ...
    insertUrl: `${REACT_APP_BASE_URL}/deponenttype`,
    updateUrl: `${REACT_APP_BASE_URL}/deponenttype`,
    removeUrl: `${REACT_APP_BASE_URL}/deponenttype`,
  ...
  //     axios
  //       .post(
  //         `${REACT_APP_BASE_URL}/deponenttype`,
  //         {
  ...
  //     axios
  //       .patch(
  //         `${REACT_APP_BASE_URL}/deponenttype?id=${args.data.id}`,
  //         {
  //           Title: args.data.title,
  //         }
  //       )
